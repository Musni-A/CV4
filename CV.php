  ...
  <div class="resume-container">
    <aside class="sidebar">
      <div class="profile-image">
        ...
        <img src="WhatsApp Image 2025-07-09 at 09.52.44_db000d58.jpg" alt="Profile Photo">
      </div>
    ...
    <main class="main-content">
      <header>
        ...
        <h2 class="job-title"><?= htmlspecialchars($personal['jobTitle'] ?? 'SOFTWARE ENGINEER') ?></h2>
      </header>
      <section class="profile-summary">
        <p>
          <?= htmlspecialchars($personal['description'] ?? 'Musni') ?>
        </p>
      </section>
